  ...
  <div class="home_page" ref="pageWindow">
    ...
    <ul class="prize_area view">
        <li v-for="area in winner" :key="area.id" v-if="area.isShow">
            ...
            <div class="prize_item" v-for="prize in area.class_list" :key="prize.id" v-if="prize.data_list.length">
                ...
                <music-label class="sub_item" v-for="(item, index) in prize.data_list" :key="index" :music="item" @play="play(item)" :playing="playingItem.id === item.id && playingItem.status === 'playing'"></music-label>
            </div>
        </li>
    </ul>
    ...
    <div class="works_area view" id="search">
        ...
        <ul class="tags">
            ...
            <li v-if="search.list[search.index]" v-for="item in search.list[search.index] ? search.list[search.index]._child : []" v-text="item.name" @click="setTags(item.id)" :class="{selected: item.id === search.tagId}"></li>
        </ul>
    ...
    <div class="partner view" v-if="partnerList.length">
        ...
        <ul>
            <li v-for="item in partnerList" @click="visitUrl(item.url)">
    ...
    methods: {
        ...
        setPrizeDisplay() {
            ...
            for (; areaIndex < areaCount; areaIndex++) {
                ...
                Vue.set(this.winner[areaIndex], 'isShow', false);
        ...
        vote(item) {
            ...
            let params = {
                log_at: window.localStorage.getItem('logat') || window.localStorage.getItem('logAt'),
                item_id: item.id
            };
